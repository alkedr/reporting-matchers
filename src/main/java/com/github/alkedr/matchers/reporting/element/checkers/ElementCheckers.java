...
public enum ElementCheckers {
    ...
    public static ElementChecker containsInSpecifiedOrderWithExtraElementsAllowed(Collection<ReportingMatcher<?>> elementMatchers) {
        return new ContainsInAnyOrderChecker(elementMatchers, true);
    }

    // TODO: тут нужны перегрузки для всех примитивных типов?
    @SafeVarargs
    public static <T> ElementChecker containsInSpecifiedOrderWithExtraElementsAllowed(T... elements) {
    ...
    // TODO: Iterable?
    public static ElementChecker containsInAnyOrderWithExtraElementsAllowed(Collection<ReportingMatcher<?>> elementMatchers) {
        return new ContainsInAnyOrderChecker(elementMatchers, true);
    }

    // TODO: тут нужны перегрузки для всех примитивных типов?
    @SafeVarargs
    public static <T> ElementChecker containsInAnyOrderWithExtraElementsAllowed(T... elements) {
