...
import static com.github.alkedr.matchers.reporting.sub.value.extractors.SubValuesExtractors.arrayElements;
...
public class ArrayElementsExtractorTest {
    ...
    public void run_null() {
        arrayElements().run(null, listener);
        inOrder.verifyNoMoreInteractions();
    }

    @Test
    public void run_empty() {
        arrayElements().run(new Object[]{}, listener);
        inOrder.verifyNoMoreInteractions();
    }
    ...
    public void run_threeElements() {
        ...
        Integer element2 = 2;
        Integer element3 = 3;
        arrayElements().run(new Object[]{element1, element2, element3}, listener);
    ...
    public void runForAbsentItem() {
        arrayElements().runForAbsentItem(listener);
        inOrder.verifyNoMoreInteractions();
    }
}
