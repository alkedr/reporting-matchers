...
import static com.github.alkedr.matchers.reporting.ReportingMatchers.createArrayElementExtractor;
...
public class ReportingMatchers_ArrayElementExtractorTest {
    @Test
