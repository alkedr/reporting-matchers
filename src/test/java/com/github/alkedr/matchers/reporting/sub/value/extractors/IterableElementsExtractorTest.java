...
import static com.github.alkedr.matchers.reporting.sub.value.extractors.SubValuesExtractors.iterableElements;
...
public class IterableElementsExtractorTest {
    ...
    public void run_null() {
        iterableElements().run(null, listener);
        inOrder.verifyNoMoreInteractions();
    }

    @Test
    public void run_empty() {
        iterableElements().run(emptyList(), listener);
        inOrder.verifyNoMoreInteractions();
    }
    ...
    public void run_threeElements() {
        ...
        Integer element2 = 2;
        Integer element3 = 3;
        iterableElements().run(asList(element1, element2, element3), listener);
    ...
    public void runForAbsentItem() {
        iterableElements().runForAbsentItem(listener);
        inOrder.verifyNoMoreInteractions();
    }
}
